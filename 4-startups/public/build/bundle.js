...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ProfileList = __webpack_require__(205);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StartupList = function (_Component) {
		...
		function StartupList(props, context) {
			...
			_this.createStartup = _this.createStartup.bind(_this);
			_this.state = {
				startup: {
					name: '',
					founder: '',
		...
		_createClass(StartupList, [{
			...
			value: function createStartup() {
				...
				_api2.default.handlePost('/api/startup', this.state.startup, function (err, response) {
					...
					_store2.default.dispatch(_actions2.default.startupCreated(response.results));
				});
			}
		}, {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement('input', { onChange: this.updateStartup, type: 'text', id: 'name', placeholder: 'Name' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { onChange: this.updateStartup, type: 'text', id: 'founder', placeholder: 'Founder' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { onChange: this.updateStartup, type: 'text', id: 'url', placeholder: 'URL' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _startupReducer = __webpack_require__(192);
	
	var _startupReducer2 = _interopRequireDefault(_startupReducer);
	
	var _profileReducer = __webpack_require__(194);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		...
		startupsReceived: function startupsReceived(startups) {
			return {
				type: _constants2.default.STARTUPS_RECEIVED,
				startups: startups
			};
		},
		...
		startupCreated: function startupCreated(startup) {
			return {
				type: _constants2.default.STARTUP_CREATED,
				startup: startup
			};
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProfileList = function (_Component) {
		...
		function ProfileList(props, context) {
			...
			_this.createProfile = _this.createProfile.bind(_this);
			_this.state = {
				profile: {
					firstName: '',
					lastName: '',
		...
		_createClass(ProfileList, [{
			...
			value: function createProfile() {
				...
				_api2.default.handlePost('/api/profile', this.state.profile, function (err, response) {
					if (err) {
						alert(err.message);
						return;
					}
					console.log('PROFILE CREATED: ' + JSON.stringify(response));
					_store2.default.dispatch(_actions2.default.profileCreated(response.results));
				});
			}
		}, {
			key: 'componentDidMount',
			value: function componentDidMount() {
				console.log('componentDidMount');
				_api2.default.handleGet('/api/profile', {}, function (err, response) {
					if (err) {
						alert(err.message);
						return;
					}
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement('input', { onChange: this.updateProfile, type: 'text', id: 'firstName', placeholder: 'First Name' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { onChange: this.updateProfile, type: 'text', id: 'lastName', placeholder: 'Last Name' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement('input', { onChange: this.updateProfile, type: 'text', id: 'email', placeholder: 'Email' }),
					_react2.default.createElement('br', null),
					_react2.default.createElement(
						'button',
	...
	exports.default = (0, _reactRedux.connect)(stateToProps)(ProfileList);
